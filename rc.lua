...
globalkeys = gears.table.join(
    -- move program to another monitor
    ...
    awful.key({ modkey,		}, "w", function() awful.spawn("chromium") end,
    	      {description = "open chromium", group = "Web"}),
...
awful.spawn.with_shell("xrandr --output VGA1 --scale 1.3x1.3")
